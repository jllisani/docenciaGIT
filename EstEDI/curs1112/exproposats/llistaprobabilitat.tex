...
% \begin{problema}
% Es vol enviar un senyal des del punt A al B a trav\'es de la xarxa de comunicaci\'o que es mostra a la figura. El senyal es bifurca per les 3 branques intentant arribar ï¬ns al punt B. Els nodes 1,2,3 i 4 poden estar oberts, no passa el senyal, o tancats, passa el senyal, de forma independent. La probabilitat que un node estigui tancat \'es igual a
% $p$. Es demana:
% \begin{itemize}
% \item [(a)] Calculeu, en funci\'o de $p$, la probabilitat que un senyal enviat des d'A arribi ï¬ns a B. 
% \item [(b)] S'ha enviat un senyal des del punt A que ï¬nalment no ha arribat a B. Calculeu en funci\'o de $p$ la probabilitat que el node 3 estigui obert. 
