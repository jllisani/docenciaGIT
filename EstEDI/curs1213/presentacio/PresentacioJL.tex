...
\subtitle{Enginyeria Edificaci\'o 2012/13.}  
...
\item[] Tutories: dimarts 11h30-13h, dijous 11h30-13h
\begin{itemize}
...
\item Activitats presencials: 
	...
	\item Examens: 19/03, 18/04, 16/05, \color{red}17/06, (16/09) \color{black}
	\end{itemize}
\item Activitats no presencials: 
	\begin{itemize}
	\item Pr\`actiques ordinador: 07/04
	\item Entrega de problemes: 18/04, 16/05, 09/06
	\end{itemize}
\item Itineraris:
	\begin{center}
	...
	Exercicis              & 20\%	&	& 20\% & Recuperable\\ \hline
...
\item Estad\'{\i}stica Descriptiva.
	\begin{itemize}
	\item [] Tema 1. An\`alisi explorat\`oria de dades.
	\item [] Tema 2. Distribucions estad\'{\i}stiques bidimensionals. 
	\item [] <2->\color{red}Examen parcial 19/03 \color{black}
	\item [] <2->\color{red}Entrega pr\`actiques 07/04 \color{black}
	\end{itemize}
\item Probabilitat.
	\begin{itemize}
	 \item [] Tema 3. Teoria de la probabilitat.
	 \item [] <3->\color{red}Examen parcial 18/04 \color{black}
	 \item [] <3->\color{red}Entrega problemes 18/04 \color{black}
	\end{itemize}
\item Estad\'{\i}stica Inferencial.
	\begin{itemize}
	\item [] Tema 4. Variables aleat\`ories discretes.
	\item [] Tema 5. Variables aleat\`ories continues.
	\item [] <4->\color{red}Examen parcial 16/05 \color{black}
	\item [] <4->\color{red}Entrega problemes 16/05 \color{black}
	\item [] Tema 6. Estimaci\'o de par\`ametres.
	\item [] Tema 7. Contrast d'hip\`otesi.
	\item [] <5->\color{red}Entrega problemes 09/06 \color{black}
	\end{itemize}
\end{itemize}
}
