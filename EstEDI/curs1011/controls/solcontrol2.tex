...
\noindent
\textbf{Solució Control 2 Aplicacions Estadístiques. Data: 25/03/2011}
...
\begin{problema}
\noindent
Una persona treu 5 bolles, amb reposició, d'una urna que conté
7 bolles blanques i 3 negres.
\begin{enumerate}[a)]
\item Quina és la probabilitat de treure 3 blanques?
\item Quina és la probabilitat de treure 3 blanques i que alguna d'elles surti en la primera o la segona extracció?
%\item Si ha tret 3 blanques, quina és la probabilidad que alguna d'elles surti en la primera o la segona extracció?
\end{enumerate}
\end{problema}
...
\noindent
Hi ha dues maneres de resoldre el problema, en ambdós casos 
...
A=``treure 3 blanques''
\newline
C=``treure bolla blanca en primera o segona extracció''
...
\noindent
Com les extraccions són amb reposició, en cada extracció tenim que: 
...
\begin{problema}
\noindent
En Toni, en Pep i na Maria es reuneixen per resoldre problemes d'estadística.
...
\begin{enumerate}[a)]
\item Quina és la probabilitat que estigui ben resolt?
\item Si el problema està mal resolt, quina és la probabilitat
que l'hagi resolt en Pep?
\item Quina és la probabilitat que estigui ben resolt i que l'hagi resolt en Toni?
\end{enumerate}
\end{problema}
...
\begin{enumerate}[i)]
\item $P(A)+P(B)+P(C)=1$ (això equival a dir que $A \cup B \cup C=\Omega$)
\item $A \cap B = \emptyset $, $A \cap C = \emptyset $, $B \cap C = \emptyset $ (disjunts 2 a dos)
\end{enumerate}

\noindent
De manera que podem utilitzar la fòrmula de la probabilitat total:
\[
