...
\problemes=0
\begin{centerline}
{\bf DISTRIBUCIONS DE PROBABILITAT CONTÍNUES NOTABLES.}
\end{centerline}
...
\item ?`Cuál es la esperanza de $ Y = 3
- X^2  $ ? \sol{a)$\mathbf{(5,\quad 1)}$ ; b) $\mathbf{E(Y) = -23}$}
\end{enumerate}
...
%al intervalo  medio en más de dos desviaciones típicas \sol{$\mathbf{0.05}$}.
%

\probl  El número medio de personas que van a un local es $1000$, con una desviación típica
de $20$ ?`Cuál es el número mínimo de sillas necesarias para que sea seguro, con una probabilidad
...
\end{enumerate}
\sol{Aproximando  por el T.L.C. a) 0.3745; b) 0.0951; c) 0.6798}
...
de ellos se nieguen a contestar? \sol{Aproximando por el T.L.C. prácticamente es 1}
...
\sol{Aproximadamente 0.0084}



%\probl
%Se lanza al aire una dado regular $100$ veces. Aplicar el Teorema del Límite Central
%para obtener la probabilidad de  que el número total de puntos obtenidos esté
%entre $300$ y $400$. 
%\sol{$\mathbf{0.9966}$ }
