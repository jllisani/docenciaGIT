...
\vspace{0.5cm}
\textbf{Exercicis Variable AleatÚria}
\end{center}
...
\item Un comerciant t\'e el producte en l'aparador tres dies. Com \'es la probabilitat que es vengui en  els pr\`oxims tres dies? %\sol{0.179, 0.97 d√≠as, 0.394.}
\end{itemize}
\end{problema}
