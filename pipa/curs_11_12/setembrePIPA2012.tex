...
%\usepackage[latin1]{inputenc}   % Permet usar tots els accents i carÃ¯Â¿Åters llatins de forma directa.
\usepackage[utf8]{inputenc}   % Permet usar tots els accents i carÃ¯Â¿Åters llatins de forma directa.
