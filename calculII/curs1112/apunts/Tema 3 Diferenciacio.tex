...
\pagestyle{fancy}
\fancyhead{}
\fancyhead[RE,RO]{Tema 3. Funcions de vàries variables. Diferenciació}
...
%Note: use of .pstex files in pdfLatex
%file.pstex, which you need to rename to file.eps.  You also need to delete the file 
%extension .pstex in \includegraphics command in the top of file.pstex_t file. 
%In your LaTeX file you use \input{file.pstex_t}.
