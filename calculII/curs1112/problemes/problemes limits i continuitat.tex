...
\pagestyle{fancy}
\fancyhead{}
\fancyhead[RE,RO]{Exercicis Tema 2. Funcions de vàries variables. Límits i continuïtat.}
...
$$
f(x,y)=\begin{cases}\displaystyle{3-x-y\over 3+x-2y} & \qquad (x,y)\not=(1,2)\cr
 & \cr
0 & \qquad (x,y)=(1,2)\cr\end{cases}
$$
